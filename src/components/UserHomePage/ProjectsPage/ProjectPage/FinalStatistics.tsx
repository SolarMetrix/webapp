  ...
  return (
    <div className="w-1/2">
      <h2 className="text-2xl font-medium text-gray-600">
        30-days statistics per product
      </h2>
        ...
        <div className="mt-4 flex items-center justify-between" key={idx}>
          <div className="flex flex-col">
            ...
            <div className="flex flex-col pl-5 text-sm text-gray-500">
              ...
              <span>
                Total insolation: {product.finalStats.totalInsolation} Wh/m<sup>2</sup>
              </span>
              <span>
                Total generated electricity:{" "}
                {(product.finalStats.totalGeneratedElectricity / 1000).toFixed(3)} kWh
              </span>
            </div>
          </div>
